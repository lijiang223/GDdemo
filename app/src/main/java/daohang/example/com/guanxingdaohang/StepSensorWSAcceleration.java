 ...
 * 加速度传感器
 */
public class StepSensorWSAcceleration extends StepSensorBase {
    private final String TAG = "StepSensorWSAcceleration";
    //存放三轴数据
    ...
    public StepSensorWSAcceleration(Context context, StepCallBack stepCallBack) {
        ...
        if (gravityOld == 0) {
            ...
            if (DetectorPeak(values, gravityOld)) {
                ...
                if (timeOfNow - timeOfLastPeak >= 200
                        && (peakOfWave - valleyOfWave >= ThreadValue) && (timeOfNow - timeOfLastPeak) <= 3000) {
